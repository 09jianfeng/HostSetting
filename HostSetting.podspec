...
Pod::Spec.new do |s|
  s.name             = 'HostSetting'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HostSetting.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/09jianfeng/HostSetting'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '09jianfeng' => 'chenjianfeng@youmi.net' }
  s.source           = { :git => 'https://github.com/09jianfeng/HostSetting.git', :tag => s.version.to_s }
